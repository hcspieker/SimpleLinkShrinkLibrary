...
using SimpleLinkShrinkLibrary.Infrastructure.Persistence.Sqlite.UnitTests.Fixtures;

namespace SimpleLinkShrinkLibrary.Infrastructure.Persistence.Sqlite.UnitTests
{
    public class ServiceCollectionTests : IClassFixture<ServiceProviderFixture>
    {
        ...
        {
            // Arrange
            _fixture.Services.EnableSqlitePersistence(_fixture.Configuration);
